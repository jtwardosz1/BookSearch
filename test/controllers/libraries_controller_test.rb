...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { address: @library.address, county_id: @library.county_id, name: @library.name, telephone: @library.telephone } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { address: @library.address, county_id: @library.county_id, name: @library.name, telephone: @library.telephone } }
